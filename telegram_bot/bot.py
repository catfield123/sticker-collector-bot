...
async def cmd_start(message: Message):
    ...
    welcome_text = (
        "Привет! \n\nЭто бот для моего мини-проекта, который помогает собирать информацию о стикерпаках!\n\n"
        ...
        "Пожалуйста, пришли из всех добавленных (ну, кроме личных)! Спасибо заранее!\n\n"
